...
#           Function to get the LED and MOTION DETECTED status                #
#        Returns the status of the LED and if there was any movement detected #
def get_ledmove_status():
...
#        os.system("sudo fswebcam ServerTest.jpg")
    ...
    hum, temp= get_temp()
    if(hum > 80 or temp > 20): # Set the alarm values
